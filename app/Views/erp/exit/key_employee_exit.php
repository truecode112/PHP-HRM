            ...
            <div class="card mb-2 <?php echo $get_animate; ?>">
              <div id="accordion">
                    ...
                    <?php if ($user_info['user_type'] == 'company') { ?>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="employee_id" data-plugin="select_hrm" data-placeholder="<?= lang('Employees.xin_employee_to_exit'); ?>" onchange="checkPendingPayrolls(this)">
                            <option value=""><?= lang('Main.choose_staff') ?></option>
                ...
                <div class="card-footer text-right">
                  ...
                  &nbsp;
                  <button type="submit" class="btn btn-primary" id="exit_role_button">
                    <?= lang('Main.xin_save'); ?>
                  </button>
                </div>
              </div>
