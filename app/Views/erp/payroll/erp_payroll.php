...
$staff_ids = $staffDetails->select(["employee_id", "user_id"])->findAll();
          ...
          <div class="col-sm-12">
            <div class="row align-items-center">
              ...
              <div class="col">
                ...
                <select id="department_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?= lang('Dashboard.dashboard_employee'); ?>" name="staff_id">
                  <option value="0">
                    All Departments
                  </option>

                  <?php foreach ($main_department as $_department) { ?>
                    <option value="<?= $_department['department_id'] ?>">
              ...
              <div class="col">
                ...
                <select id="all_staff_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?= lang('Dashboard.dashboard_employee'); ?>" name="staff_id">
                  <option value="0">
                    All Staff ID's
                  </option>

                  <?php foreach ($staff_ids as $id) { ?>
              ...
              <div class="col">
                ...
                <button type="button" class="btn btn-danger" onclick="location.reload()"><i data-feather="refresh-cw"></i></button>
              </div>
            </div>
          </div>
        </div>
