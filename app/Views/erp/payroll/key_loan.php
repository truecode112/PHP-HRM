...
<div id="smartwizard-2" class="border-bottom smartwizard-example sw-main sw-theme-default mt-2">
  <ul class="nav nav-tabs step-anchor">
   ...
   <?php if(in_array('loan1',staff_role_resource()) || $user_info['user_type'] == 'company') {?>
    <li class="nav-item active"> <a href="<?= site_url('erp/loan-request');?>" class="mb-3 nav-link"> <span class="sw-done-icon feather icon-check-circle"></span> <span class="sw-icon fas fa-file-invoice-dollar"></span>
      <?= lang('Main.xin_loan');?>
      <div class="text-muted small">
...
<div class="row m-b-1 animated fadeInRight">
  <div class="col-md-12">
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      ...
      <?php echo form_open_multipart('erp/payroll/add_loan', $attributes, $hidden);?>
      <div class="row">
        <div class="col-md-12">
          <div class="card mb-2">
            <div id="accordion">
              <div class="card-header">
                <h5>
                  <?= lang('Employee.xin_request_loan');?>
                </h5>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="month_year">
                        <?= lang('Employees.start_date');?> <span class="text-danger">*</span>
                      </label>
                      <div class="input-group">
                        <input class="form-control hr_month_year" placeholder="<?= lang('Employees.start_date');?>" name="month_year" type="text">
              ...
              <div class="col-md-4">
                    <div class="form-group">
                      <label for="month_year">
                        <?= lang('Employees.end_date');?> <span class="text-danger">*</span>
                      </label>
                      <div class="input-group">
                        <input class="form-control hr_month_year" placeholder="<?= lang('Employees.end_date');?>" name="end_date" type="text">
                        <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
                      </div>
                    </div>
                  </div>
