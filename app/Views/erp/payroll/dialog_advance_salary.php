...
<div class="modal-body">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="input-group">
            <input class="form-control d_month_year" placeholder="<?= lang('Employees.start_date');?>" name="month_year" type="text" value="<?= $result['month_year'];?>">
  ...
  <div class="col-md-12">
        <div class="form-group">
          ...
          <div class="input-group">
            <input class="form-control d_month_year" placeholder="<?= lang('Employees.end_date');?>" name="end_date" type="text" value="<?= $result['end_date'];?>">
            <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
          </div>
        </div>
      </div>
