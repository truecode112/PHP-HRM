...
$employee_Salary = $request->getGet('emp_salary');
...
?>
  ...
  <div class="modal-body">
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label for="amount_option">
            ...
            <span class="text-danger">*</span></label>
          <select name="is_fixed" class="form-control" data-plugin="select_hrm" id="edit_employee_allowance" onchange="editEmployeeAllowance(this)">
      ...
      <div class="col-md-6 <?php if ($result['is_fixed'] == 2) : ?><?php else : ?> d-none <?php endif; ?> " id="edit_percentage_window">
        <?php
        $percentage = ($result['contract_amount'] / $employee_Salary) * 100;
        ?>
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="<?= lang('Employees.xin_title_tax_percent'); ?>" type="text" id="edit_employee_percentage" value="<?= $percentage ?>" onkeyup="calculateEmployeeAllowancePercentage(this)">
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="<?= lang('Invoices.xin_amount'); ?>" name="contract_amount" type="text" value="<?= $result['contract_amount']; ?>" <?php if ($result['is_fixed'] == 2) : ?> readonly="true" <?php else : ?> <?php endif; ?> id="edit_amount_to_be_calculate">
          </div>
        </div>
      </div>
    </div>
...
?>
  ...
  <div class="modal-body">
    <div class="row">
      ...
      <div class="col-md-6 <?php if ($result['is_fixed'] == 2) : ?><?php else : ?> d-none <?php endif; ?> " id="edit_commission_percentage_window">
        <?php
        $percentage = ($result['contract_amount'] / $employee_Salary) * 100;
        ?>
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="<?= lang('Employees.xin_title_tax_percent'); ?>" type="text" id="edit_employee_commission_percentage" value="<?= $percentage ?>" onkeyup="calculateEmployeeCommissionPercentage(this)">
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          <label for="amount_option">
            <?= lang('Employees.xin_amount_option'); ?>
            <span class="text-danger">*</span></label>
          <select name="is_fixed" class="form-control" data-plugin="select_hrm" onchange="editEmployeeCommission(this)">
            <option value="1" <?php if ($result['is_fixed'] == 1) : ?> selected="selected" <?php endif; ?>>
              <?= lang('Employees.xin_title_tax_fixed'); ?>
            </option>
            <option value="2" <?php if ($result['is_fixed'] == 2) : ?> selected="selected" <?php endif; ?>>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="<?= lang('Invoices.xin_amount'); ?>" name="contract_amount" type="text" value="<?= $result['contract_amount']; ?>" <?php if ($result['is_fixed'] == 2) : ?> readonly="true" <?php else : ?> <?php endif; ?> id="edit_commission_amount_to_be_calculate">
          </div>
        </div>
      </div>
    </div>
...
?>
  ...
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <label for="amount_option">
            ...
            <span class="text-danger">*</span></label>
          <select name="is_fixed" class="form-control" data-plugin="select_hrm" onchange="changeEmployeeStatutoryPercentage(this)">
            <option value="1" <?php if ($result['is_fixed'] == 1) : ?> selected="selected" <?php endif; ?>>
              <?= lang('Employees.xin_title_tax_fixed'); ?>
            </option>
            <option value="2" <?php if ($result['is_fixed'] == 2) : ?> selected="selected" <?php endif; ?>>
      ...
      <div class="col-md-6 <?php if ($result['is_fixed'] == 2) : ?><?php else : ?> d-none <?php endif; ?> " id="edit_statutory_percentage_window">
        <?php
        $percentage = ($result['contract_amount'] / $employee_Salary) * 100;
        ?>
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="<?= lang('Employees.xin_title_tax_percent'); ?>" type="text" id="edit_employee_commission_percentage" value="<?= $percentage ?>" onkeyup="calculateEmployeeStatutoryPercentage(this)">
          </div>
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="<?= lang('Invoices.xin_amount'); ?>" name="contract_amount" type="text" value="<?= $result['contract_amount']; ?>" <?php if ($result['is_fixed'] == 2) : ?> readonly="true" <?php else : ?> <?php endif; ?> id="edit_statutory_amount_to_be_calculate">
          </div>
        </div>
      </div>
    </div>
...
?>
  ...
  <div class="modal-body">
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label for="amount_option">
            <?= lang('Employees.xin_amount_option'); ?>
            <span class="text-danger">*</span></label>
          <select name="is_fixed" class="form-control" data-plugin="select_hrm" onchange="changeEmployeeOtherPaymentPercentage(this)">
            <option value="1" <?php if ($result['is_fixed'] == 1) : ?> selected="selected" <?php endif; ?>>
              <?= lang('Employees.xin_title_tax_fixed'); ?>
            </option>
            <option value="2" <?php if ($result['is_fixed'] == 2) : ?> selected="selected" <?php endif; ?>>
      ...
      <div class="col-md-6 <?php if ($result['is_fixed'] == 2) : ?><?php else : ?> d-none <?php endif; ?> " id="edit_other_payment_percentage_window">
        <?php
        $percentage = ($result['contract_amount'] / $employee_Salary) * 100;
        ?>
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="<?= lang('Employees.xin_title_tax_percent'); ?>" type="text" id="edit_employee_commission_percentage" value="<?= $percentage ?>" onkeyup="calculateEmployeeOtherPaymentPercentage(this)">
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="input-group">
            <div class="input-group-prepend"><span class="input-group-text">
              ...
              <input class="form-control" placeholder="<?= lang('Invoices.xin_amount'); ?>" name="contract_amount" type="text" value="<?= $result['contract_amount']; ?>" <?php if ($result['is_fixed'] == 2) : ?> readonly="true" <?php else : ?> <?php endif; ?> id="edit_other_payment_amount_to_be_calculate">
          </div>
        </div>
      </div>
    </div>
