...
<div class="form-group" id="designation_ajax">
  ...
  <select onchange="addnewNewDesignation()" class="form-control" name="designation_id" data-plugin="select_hrm" data-placeholder="<?= lang('Dashboard.left_designation');?>" id="designation_id">
    <option value="">
    <?= lang('Dashboard.left_designation');?>
    </option>
    ...
    <?php } ?>
    <option value="add_designation"><?= lang('Dashboard.add_new_designation');?></option>
  </select>
</div>
