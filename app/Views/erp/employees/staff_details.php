    ...
    <div class="card user-card user-card-1">
      ...
      <ul class="list-group list-group-flush mb-3">
        <li class="list-group-item"> <span class="f-w-500"><i class="feather icon-user m-r-10"></i>
            ...
            <?php
            if (isset($dep_user)) {
              echo $dep_user['first_name'] . ' ' . $dep_user['last_name'];
            }
            ?>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <input type="text" class="form-control date" name="contract_date" placeholder="<?= lang('Employees.xin_contract_date'); ?>" value="<?= date('Y-m-d', strtotime($employee_detail['date_of_joining'])); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>
                            <?= lang('Employees.contract_type'); ?>
                            <span class="text-danger">*</span></label>
                          <select name="contract_type" class="form-control" data-plugin="select_hrm" data-placeholder="<?= lang('Employees.select_contract'); ?>">
                            <option value=""><?= lang('Employees.select_contract') ?></option>
                            <option value="1" <?php if ($employee_detail['contract_type'] == 1) : ?> selected="selected" <?php endif; ?>><?= lang('Employees.permanent') ?></option>
                            <option value="2" <?php if ($employee_detail['contract_type'] == 2) : ?> selected="selected" <?php endif; ?>><?= lang('Employees.part_time') ?></option>
                            <option value="3" <?php if ($employee_detail['contract_type'] == 3) : ?> selected="selected" <?php endif; ?>><?= lang('Employees.daily') ?></option>
                            <option value="4" <?php if ($employee_detail['contract_type'] == 4) : ?> selected="selected" <?php endif; ?>><?= lang('Employees.contractual') ?></option>
                          </select>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="basic_salary" placeholder="<?= lang('Employees.xin_gross_salary'); ?>" value="<?= $employee_detail['basic_salary']; ?>" id="employee_basic_salary">
                            <input type="hidden" name="default_currency" value="<?= $xin_system['default_currency']; ?>" id="default_currency_system">
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-4">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <select name="salay_type" id="salay_type" class="form-control" data-plugin="select_hrm">
                            ...
                            <option value="3" <?php if ($employee_detail['salay_type'] == 3) : ?> selected="selected" <?php endif; ?>>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="payment_mode" id="payment_mode" class="form-control" data-plugin="select_hrm" data-placeholder="<?= lang('Employees.select_payment'); ?>">
                            ...
                            <option value="1" <?php if ($employee_detail['payment_mode'] == 1) : ?> selected="selected" <?php endif; ?>>
                              <?= lang('Employees.ebanking'); ?>
                            </option>
                            <option value="2" <?php if ($employee_detail['payment_mode'] == 2) : ?> selected="selected" <?php endif; ?>>
                              <?= lang('Employees.cheque'); ?>
                            </option>
                            <option value="3" <?php if ($employee_detail['payment_mode'] == 3) : ?> selected="selected" <?php endif; ?>>
                              <?= lang('Employees.cash'); ?>
                            </option>
                          ...
                          <?php if ($mattribute['attribute_type'] == 'date') { ?>
                            ...
                            <div class="<?= $mattribute['col_width']; ?>">
                              <div class="form-group">
                                ...
                                <input class="form-control date" placeholder="<?php echo $mattribute['attribute_label']; ?>" name="<?php echo $mattribute['attribute']; ?>" type="text" value="<?= $attr_val; ?>">
                              </div>
                            </div>
                ...
                <div class="tab-pane fade" id="pills-allowances" role="tabpanel" aria-labelledby="pills-allowances-tab">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="amount_option">
                            ...
                            <span class="text-danger">*</span></label>
                          <select name="is_fixed" class="form-control" data-plugin="select_hrm" id="employee_add_allowance_type">
                            <option value="1">
                      ...
                      <div class="col-md-6 d-none" id="percentage_window">
                        <div class="form-group">
                          <label for="account_numberss">
                            <?= lang('Employees.xin_title_tax_percent'); ?>
                            <span class="text-danger">*</span></label>
                          <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text">
                            ...
                            <input class="form-control" placeholder="<?= lang('Employees.xin_title_tax_percent'); ?>" type="text" id="employee_percentage">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input class="form-control" placeholder="<?= lang('Invoices.xin_amount'); ?>" name="contract_amount" type="text" id="amount_to_be_calculate">
                          </div>
                        </div>
                      </div>
                ...
                <div class="tab-pane fade" id="pills-commissions" role="tabpanel" aria-labelledby="pills-commissions-tab">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="amount_option">
                            <?= lang('Employees.xin_amount_option'); ?>
                            <span class="text-danger">*</span></label>
                          <select name="is_fixed" class="form-control" data-plugin="select_hrm" id="allownace_type">
                            <option value="1">
                              <?= lang('Employees.xin_title_tax_fixed'); ?>
                            </option>
                            <option value="2">
                      ...
                      <div class="col-md-6 d-none" id="percentage_window_allowance">
                        <div class="form-group">
                          <label for="account_numberss">
                            <?= lang('Employees.xin_title_tax_percent'); ?>
                            <span class="text-danger">*</span></label>
                          <div class="input-group">
                            ...
                            <input class="form-control" placeholder="<?= lang('Employees.xin_title_tax_percent'); ?>" type="text" id="allowance_employee_percentage">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input class="form-control" placeholder="<?= lang('Invoices.xin_amount'); ?>" name="contract_amount" type="text" id="allowance_amount_to_be_calculate">
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="tab-pane fade" id="pills-statutory" role="tabpanel" aria-labelledby="pills-statutory-tab">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="amount_option">
                            ...
                            <span class="text-danger">*</span></label>
                          <select name="is_fixed" class="form-control" data-plugin="select_hrm" id="statutory_add">
                            <option value="1">
                              <?= lang('Employees.xin_title_tax_fixed'); ?>
                            </option>
                            <option value="2">
                      ...
                      <div class="col-md-6 d-none" id="statutory_window_allowance">
                        <div class="form-group">
                          <label for="account_numberss">
                            <?= lang('Employees.xin_title_tax_percent'); ?>
                            <span class="text-danger">*</span></label>
                          <div class="input-group">
                            ...
                            <input class="form-control" placeholder="<?= lang('Employees.xin_title_tax_percent'); ?>" type="text" id="statutory_employee_percentage">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input class="form-control" placeholder="<?= lang('Invoices.xin_amount'); ?>" name="contract_amount" type="text" id="statutory_amount_to_be_calculate">
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="tab-pane fade" id="pills-reimbursements" role="tabpanel" aria-labelledby="pills-reimbursements-tab">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="amount_option">
                            <?= lang('Employees.xin_amount_option'); ?>
                            <span class="text-danger">*</span></label>
                          <select name="is_fixed" class="form-control" data-plugin="select_hrm" id="other_payment_add">
                            <option value="1">
                              <?= lang('Employees.xin_title_tax_fixed'); ?>
                            </option>
                            <option value="2">
                      ...
                      <div class="col-md-6 d-none" id="other_payment_window_allowance">
                        <div class="form-group">
                          <label for="account_numberss">
                            <?= lang('Employees.xin_title_tax_percent'); ?>
                            <span class="text-danger">*</span></label>
                          <div class="input-group">
                            ...
                            <input class="form-control" placeholder="<?= lang('Employees.xin_title_tax_percent'); ?>" type="text" id="other_payment_employee_percentage">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input class="form-control" placeholder="<?= lang('Invoices.xin_amount'); ?>" name="contract_amount" type="text" id="other_payment_amount_to_be_calculate">
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="card-body pb-2">
              <div class="box-body">
                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    <label for="allergies"><?= lang('Dashboard.allergies') ?></label>
                    <textarea name="allergies" id="allergies" class="form-control"><?= $employee_detail['allergies'] ?></textarea>
                  </div>
                </div>
              </div>
            </div>
